...
public class TermClickCountServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public TermClickCountServlet() {
		super();
	}
	...
	private void save(JSONArray jsonArray) {
		...
		try {
			...
			String insert = "insert into t_stat_res_1002(macid,clicktotal,adddate)"
					+ " values(?,?,?)";
			...
			for (int i = 0; i < jsonArray.size(); i++) {
				...
				int restotal = jsonObj.getInt("clicktotal");
