...
public final class HttpHelper {
	...
	/**
	 * post接口的json封装 使用注意：（1） 只有json类型的param映射才被支持。 （2）
	 * post默认以x-www-form-urlencoded接收，并且，所有的参数都必须是用String接收， 之后再解析为其它类型（json
	 * array需要先用String接收，之后用JSONArray解析）
	 * 
	 * @param headers
	 *            可以为空，请求头(注意，当前版本不支持post为json格式)
	 * @param params
	 *            post的参数
	 * @param url
	 *            请求URL
			...
			for (String key : keySet) {
				...
				if (obj != null) {
					...
					if (obj instanceof String) {
						...
						// Other (known)
						throw new Exception("Map<String, Object>, String)，未知json 参数类型!" + "["
	 ...
	 *            ：指定socket timeout 和 connection timeout ，单位是ms
	 * @return
	 * @throws Exception
	 */
	 ...
	 * @param url
	 * @param timeOutInMillis
	 *            :指定socket timeout 和 connection timeout
	 *            ，单位是ms，传入0或负数，代表不设置，默认为不超时
	 * @return
	 * @throws Exception
	 */
	...
	public static String post(Map<String, String> headers, List<NameValuePair> params, String url, int timeOutInMillis)
			throws Exception {
		HttpPost post = null;
		try {
			post = getHttpPost(headers, params, url, timeOutInMillis);
	 ...
	 * @throws Exception
	 */
	public static Map<String, Object> postWithReturnCode(Map<String, String> headers, Map<String, String> params,
	...
	private static HttpPost getHttpPost(Map<String, String> headers, List<NameValuePair> params, String url,
			int timeOutInMillis) throws Exception {
		HttpPost post = null;
		post = new HttpPost(url);
	...
	public static Map<String, Object> postJsonWithReturnCode(Map<String, String> headers, String jsonObject,
			String url, int timeOutInMillis) throws Exception {
		HttpPost post = null;
		try {
			post = new HttpPost(url);
	...
	public static String get(Map<String, String> headers, Map<String, String> params, String url, String charset)
			throws Exception {
	 ...
	 * @throws Exception
	 */
	public static Map<String, Object> getWithReturnCode(Map<String, String> headers, Map<String, String> params,
			String url, String charset, int timeOutInMillis) throws Exception {
		HttpGet get = null;
		try {
			get = getHttpGet(headers, params, url, charset, timeOutInMillis);
	...
	private static HttpGet getHttpGet(Map<String, String> headers, Map<String, String> params, String url,
			String charset, int timeOutInMillis) throws Exception {
		HttpGet get = null;
		if (params != null) {
	...
	public static String post(Map<String, String> basicParams, String url, Map<String, byte[]> fileParams)
			throws Exception {
		HttpPost post = null;
		try {
			post = new HttpPost(url);
	...
	public static String urlUTF8Encode(String str) throws UnsupportedEncodingException {
	...
	public static String postFile(String url, Map<String, Object> params, Map<String, String> header) throws Exception {
		HttpPost post = null;
		try {
			post = new HttpPost(url);
