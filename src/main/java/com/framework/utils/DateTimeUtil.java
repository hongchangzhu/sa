...
public class DateTimeUtil {
	...
	public final static String DATETIME_FORMAT2 = "yyyyMMdd";
	public final static String DATETIME_FORMAT3 = "yyyyMMddHHmmss";
	...
	public static String formatDateTime(Date d) {
		return formatDate(DATETIME_FORMAT, d);
	}
	...
	public static boolean isDateTimeFormat(String date) {
		...
		if (!Pattern.matches("[12]{1}[09]{1}\\d{2}-[01]?[0-9]?-[0-3]?[0-9]?\\s+[0-5]?[0-9]?:[0-5]?[0-9]?:[0-5]?[0-9]?",
				date)) {
			return false;
		}
		return true;
	...
	public static String getYearMonth(Date time) {
		...
		return String.valueOf(cal.get(Calendar.YEAR))
				+ ((cal.get(Calendar.MONTH) >= 9) ? String.valueOf(cal.get(Calendar.MONTH) + 1) : "0"
